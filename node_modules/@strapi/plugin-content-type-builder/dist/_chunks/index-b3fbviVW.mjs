...
const ListView$1 = lazy(() => import("./ListView-sY6Y4JQS.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-sY6Y4JQS.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-b3fbviVW.mjs.map
