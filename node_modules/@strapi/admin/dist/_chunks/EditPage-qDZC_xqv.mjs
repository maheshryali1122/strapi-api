...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-dMS-26Ft.mjs";
...
import { u as useWebhooks } from "./useWebhooks-tlVKrkap.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-Q06Y91lz.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-qDZC_xqv.mjs.map
