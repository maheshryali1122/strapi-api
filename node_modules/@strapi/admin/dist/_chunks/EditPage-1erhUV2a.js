...
const useWebhooks = require("./useWebhooks-qzzi2dzq.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-6ux_fTpD.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-1erhUV2a.js.map
